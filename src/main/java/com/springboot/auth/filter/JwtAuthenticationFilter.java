...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected String delegateAccessToken(Member member){
        ...
        String accessToken =
                jwtTokenizer.generatedAccessToken(claims, subject, expiration, base64EncodedSecretKey);
    ...
    protected String delegateRefreshToken(Member member){
        ...
        String base64EncodedSecretKey =
                jwtTokenizer.encodeBase64SecretKey(jwtTokenizer.getSecretKey());
        String refreshToken =
                jwtTokenizer.generatedRefreshToken(subject, expiration, base64EncodedSecretKey);
